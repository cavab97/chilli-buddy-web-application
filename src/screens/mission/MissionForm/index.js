...
class MissionForm extends Component {
    ...
    if (
      ...
      if (submitResult.action === "Delete mission") {
        ...
        this.props.history.push(
          `/home/routegroup/${routeGroupID}/route/${routeID}/mission/${mission.id}`
        );
      }
    }
  }
  ...
  jumpBack(key) {
    ...
    switch (key) {
      ...
      case "mission":
        this.props.history.push(
          `/home/routegroup/${params.routeGroupID}/route/${params.routeID}/mission/${params.missionID}`
        );
        break;
    }
  }
    ...
    return (
      <ScreenHolder>
        ...
        <ContentBox
          title={
            <Bcrumb separator="/">
              <BcrumbItem onClick={this.jumpBack.bind(this, "routeGroupList")}>
                Route Groups
              </BcrumbItem>
              ...
              {mission.id && <BcrumbItem>Mission</BcrumbItem>}
            </Bcrumb>
          }
