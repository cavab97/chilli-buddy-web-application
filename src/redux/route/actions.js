...
const actions = {
  ...
  readFromDatabase: (routeGroupID) => {
    return { 
          type: actions.READ_FROM_DATABASE ,
          payload: { routeGroupID }
        };
  },
  ...
  submitToBackend: (data, actionName = 'insert', routeGroupID) => (
    {
    type: actions.SUBMIT_TO_BACKEND,
    payload: { data, actionName, routeGroupID },
  }),
  ...
  uploadFile: ({routeId, file = null})=>({
    type: actions.UPLOAD_TO_STORAGE,
    payload: { data: {routeId, file} },
  }),
