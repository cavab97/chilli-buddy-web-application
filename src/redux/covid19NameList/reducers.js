...
export default function reducer(state = initState, { type, payload }) {
  switch (type) {
    case actions.READ_FROM_LOCAL_STORAGE:
      return {
        ...state,
        covid19NameLists: [],
        readLoading: true,
    ...
    case actions.READ_FROM_LOCAL_STORAGE_SUCCESS:
      return {
        ...state,
        readLoading: false,
        covid19NameList: { ...state.covid19NameList, ...payload.data },
        readError: false,
      };
    case actions.READ_FROM_LOCAL_STORAGE_ERROR:
      return {
        ...state,
        readLoading: false,
    ...
    case actions.READ_SPECIFIED_RECORD_SUCCESS:
      return {
        ...state,
        readSpecifiedRecordLoading: false,
        covid19NameList: payload.data ? payload.data : initState.covid19NameList,
        readSpecifiedRecordError: false,
      };
    ...
    case actions.SUBMIT_TO_BACKEND_SUCCESS:
      return {
        ...
        covid19NameList: { ...state.covid19NameList, id: payload.data.ids[0] },
      };
    ...
    case actions.MODAL_PAGE_CONTROL:
      return {
        ...state,
        modalSuccessPage: !state.modalSuccessPage,
      };
